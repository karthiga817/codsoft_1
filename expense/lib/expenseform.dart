...
class _ExpenseFormState extends State<ExpenseForm> {
  ...
  void _submitForm() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(
              'Total Expenses Added: \$${newTotal.toStringAsFixed(2)}, Grand Total: \$${totalExpenses.toStringAsFixed(2)}')),
    );
          ...
          children: [
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(255, 111, 185, 245)),
            ),
            SizedBox(height: 20),
            Text(
              'Total Expenses: \$${totalExpenses.toStringAsFixed(2)}',
              style: TextStyle(
                  fontSize: 20), // Optional: Increase font size for visibility
            ),
            SizedBox(height: 20),
  ...
  void _setSavingsGoal(BuildContext context) {
    ...
    if (goal > 0) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content:
            Text('Savings goal set to \$${savingsGoal.toStringAsFixed(2)}'),
      ));
